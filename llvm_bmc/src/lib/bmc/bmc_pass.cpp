...
void bmc_pass::translateCallInst( unsigned bidx,
  ...
  }  else if( fp != NULL && fp->getName().startswith("ada__numerics__elementary_functions") ) { //Do nothing - to be confirmed
    //std::cout << "These are Ada library functions\n";
  }else {
